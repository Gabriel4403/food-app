...
// About page — shows the app story and core values
export default function AboutPage() {
  return (
    <div className="min-h-screen mt-40 sm:mt-30 py-4">
      {/* Brand story section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-amber-100 p-6 rounded-lg text-center">
              ...
              <p className="text-gray-600">
                Every dish is prepared by chefs who care about your dining experience.
              </p>
            </div>
          </div>
        </div>
